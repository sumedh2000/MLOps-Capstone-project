...
texinfo_documents = [
    ('index', 'capstone_project', u'Capstone Project Documentation',
     u"Sumedh Bhatwadekar", 'Capstone Project',
     'This is an end to end MLOps project till monitoring', 'Miscellaneous'),
]
